 ...
 */
void mpc_main(uint8_t INPUT_A_hsn, uint16_t INPUT_A_tsn, uint8_t INPUT_A_firstlic, uint8_t INPUT_A_takerlic) {
    uint16_t price = 0;
    uint8_t catcar = 0;
    ...
    uint16_t OUTPUT_price = price;
    uint16_t OUTPUT_catcar = catcar;
}
