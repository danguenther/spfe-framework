...
*/
void mpc_main(uint8_t INPUT_A_damagefreeclasshp, uint8_t INPUT_A_damagefreeclassvk, fixedpt INPUT_A_price) {
    ...
    fixedpt OUTPUT_pricehp = fixedpt_mul(helphp, fixedpt_mul(price, 81920));
    fixedpt OUTPUT_pricetk = fixedpt_mul(helpvk, fixedpt_mul(price, 81920));
    fixedpt OUTPUT_pricevk = fixedpt_mul(helpvk, fixedpt_mul(price, 81920));
}
